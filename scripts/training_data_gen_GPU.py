...
def build_training(files,features):
    ...
    if len(files) == 1:
        training_data = build_df(pd.read_csv('/home/infres/cshelbourne/generated_traces/' + files[0] + '.csv'),
                                 features)
        ...
        for i, file in enumerate(files):
            if i == 0:
                training_data = build_df(pd.read_csv('/home/infres/cshelbourne/generated_traces/' + file + '.csv'),
                                         features)
                ...
                data = build_df(pd.read_csv('/home/infres/cshelbourne/generated_traces/' + file + '.csv'),
                                features)
...
def build_training_test_data(features,
    ...
    if varied == True:
        ...
        if tag_train in ["fx","fxL","ps",'pcpPINJ1','pcpPINJ2','pcpDC1','pcpDC2'] and tag_test in ["fx","fxL","ps",'pcpPINJ1','pcpPINJ2','pcpDC1','pcpDC2'] :
            ...
            file = '/home/infres/cshelbourne/generated_traces/'+ tag_train + '_trainingData_Rvaried'+str(set_1)+'.csv'
            ...
            file = '/home/infres/cshelbourne/generated_traces/' + tag_test + '_trainingData_Rvaried' + str(4) + '.csv'
            df_val = build_df(pd.read_csv(file), features)
            df_val = df_val.rolling(window_size).mean()
            df_val = df_val[window_size:len(df_val)]

            file = '/home/infres/cshelbourne/generated_traces/' + tag_test + '_trainingData_Rvaried' + str(5) + '.csv'
        ...
        elif tag_test in ["fx","fxL","ps",'pcpINJ1','pcpINJ2','pcpDC1','pcpDC2']:
            ...
            file = '/home/infres/cshelbourne/generated_traces/' + tag_train + '_trainingData_Rvaried' + str(
                set_1) + '.csv'
            df_train = build_df(pd.read_csv(file), features)
            df_train = df_train.rolling(window_size).mean()
            df_train = df_train[window_size:len(df_train)]
